...
class Notes(BaseManual):
    ...
    \r\nПримечание 1: стандартный способ отображения информации — графический. \
    Переключить его можно с помощью опции «~~о».
    \r\nПримечание 2: при использовании команды вместе с прикрепленным сообщением другого участника, \
    данные которого привязаны к базе данных бота, имеется возможность посмотреть его заметки путешественника.
    \r\nСинтаксис: !заметки [сообщение другого участника] [опции]
    \r~~п > текущая помощь по команде
    \r~~о {текст / пик} > переключение способа отображения информации на текстовый или графический
    '''
...
class Stats(BaseManual):
    ...
    Переключить его можно с помощью опции «~~о».
    \r\nПримечание 2: при использовании команды вместе с прикрепленным сообщением другого участника, \
    данные которого привязаны к базе данных бота, имеется возможность посмотреть его внутриигровую статистику.
    \r\nСинтаксис: !статы [сообщение другого участника] [опции]
    \r~~п > текущая помощь по команде
    \r~~о {текст / пик} > переключение способа отображения информации на текстовый или графический
    '''
...
class Rewards(BaseManual):
    ...
    Переключить его можно с помощью опции «~~о».
    \r\nПримечание 2: при использовании команды вместе с прикрепленным сообщением другого участника, \
    данные которого привязаны к базе данных бота, имеется возможность посмотреть его ежедневные отметки.
    \r\nСинтаксис: !награды [сообщение другого участника] [опции]
    \r~~п > текущая помощь по команде
    \r~~о {текст / пик} > переключение способа отображения информации на текстовый или графический
    '''
...
class Codes(BaseManual):
    ...
    \r\nПримечание 3: при использовании команды вместе с прикрепленным сообщением другого участника, \
    данные которого привязаны к базе данных бота, имеется возможность активировать промокоды на его аккаунте.
    \r\nСинтаксис: !пром [сообщение другого участника] [опции] [промокод-1] [промокод-2] [промокод-n]
    \r~~п > текущая помощь по команде
    '''
...
class Diary(BaseManual):
    ...
    \r\nСинтаксис: !дневник [сообщение другого участника] [опции]
    \r~~п > текущая помощь по команде
    \r~~о {текст / пик} > переключение способа отображения информации на текстовый или графический
    '''
...
class SpiralAbyss(BaseManual):
    ...
    \r\nПримечание 1: при использовании команды вместе с прикрепленным сообщением другого участника, \
    данные которого привязаны к базе данных бота, имеется возможность посмотреть его прогресс витой бездны.
    \r\nСинтаксис: !бездна [сообщение другого участника] [опции]
    \r~~п > текущая помощь по команде
    '''
