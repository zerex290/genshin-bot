...
class Notes(BaseManual):
    ...
    данные которого привязаны к базе данных бота, имеется возможность посмотреть его игровые путешественника.
    \r\nСинтаксис: !заметки [опции] [сообщение другого участника]
    \r~~п > текущая помощь по команде
...
class Stats(BaseManual):
    ...
    \r\nСинтаксис: !статы [опции] [сообщение другого участника]
    \r~~п > текущая помощь по команде
    \r~~о {текст / пик} > переключение способа отображения информации на текстовый или графический
    '''
...
class Rewards(BaseManual):
    ...
    \r\nСинтаксис: !награды [опции] [сообщение другого участника] 
    \r~~п > текущая помощь по команде
    \r~~о {текст / пик} > переключение способа отображения информации на текстовый или графический
    '''
...
class Codes(BaseManual):
    ...
    \r\nСинтаксис: !пром [опции] [сообщение другого участника] [промокод-1] [промокод-2] [промокод-n]
    \r~~п > текущая помощь по команде
    '''
...
class Diary(BaseManual):
    ...
    \r\nСинтаксис: !дневник [опции] [сообщение другого участника]
    \r~~п > текущая помощь по команде
    \r~~о {текст / пик} > переключение способа отображения информации на текстовый или графический
    '''
...
class SpiralAbyss(BaseManual):
    ...
    \r\nСинтаксис: !бездна [опции] [сообщение другого участника]
    \r~~п > текущая помощь по команде
    '''
