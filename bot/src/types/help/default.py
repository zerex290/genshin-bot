...
class Guide(Enum):
    _default = 'Список существующих команд: vk.com/@bot_genshin-commands'
    _help = '''
...
class Attachments(Enum):
    _help = '''
        ...
        \r\nПримечание 2: бот не сможет переслать больше 3 изображений за раз. Эти ограничения наложены самим Вконтакте.
