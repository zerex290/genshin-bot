...
def get_timestamp_from_unix(tz_offset: int, unix_timestamp: int | float) -> datetime.datetime:
    return datetime.datetime.fromtimestamp(unix_timestamp, get_tz(tz_offset))
